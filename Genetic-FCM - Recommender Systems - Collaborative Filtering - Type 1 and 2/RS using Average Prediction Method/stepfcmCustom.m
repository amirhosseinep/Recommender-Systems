function [U_new, center, obj_fcn] = stepfcmCustom(data, U, cluster_n, expo,globalPopArray)
...
%inja az center e genetic estefade mikonim.yani mishe centers(3,1682)
center=globalPopArray;
