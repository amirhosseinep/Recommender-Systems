function [center, U, obj_fcn] = fcmCustom(data, cluster_n, options,globalPopArray)
...
default_options = [2;	% exponent for the partition matrix U
		600;	% max. number of iteration
		10;	% min. amount of improvement1e-5;
...
% Main loop
for i = 1:max_iter,
	[U, center, obj_fcn(i)] = stepfcmCustom(data, U, cluster_n, expo,globalPopArray);
	if display, 
